...
[ ] for text editing mode, for the Grouped behavior let's use the style of the toolbar from the Flat, when text controls are explicit one line toolbar - popover for the font steals too much space. Make that behavior controlable from the Lab panel and enabled by default
...
[ ] add a 3-vertical-dot menu at the end of formatting toolbar. It will be used for rare operations/actions such as Set default style, copy/paste style etc. Make it optional via toggle in the Lab panel.
