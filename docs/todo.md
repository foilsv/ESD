...
[ ] get rid of the drowdown arrows for a simple action popovers (color, alignemet etc.). They make the toolbar busier, while customer in general expecting color to be a popover. Make it optional bia Lab panel with down arrows disabled by default
